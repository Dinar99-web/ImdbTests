# Проект по автоматизации тестирования для сервиса [IMDb](https://s.media-imdb.com/) <a href="https://s.media-imdb.com/"><img src="media/4373703_imdb_logo_logos_icon.svg" width="50" height="50"  alt="IDEA"/>
